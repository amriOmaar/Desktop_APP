...
public class OffreCardFormController {
    ...
    private void click(MouseEvent mouseEvent) {
      MyListenerTran.onClickListener(Moyen_Transport);
      
    }
    
    public void setData(Moyen_Transport Moyen_Transport, MyListenerTran MyListenerTran) {
        this.Moyen_Transport = Moyen_Transport;
        this.MyListenerTran = MyListenerTran;
